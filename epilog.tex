...
选择都使得 单行程序变成可能. 作为作者, 我们非常清楚地知道 awk
将会被如何地使用, 所以我们只写单行程序.\footnote{原文是 We, being the
    authors, ``knew'' how the language was supposed to be used, and so we
    only wrote one-liners.}
